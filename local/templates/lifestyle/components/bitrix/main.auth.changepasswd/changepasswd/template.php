...
<div class="login__form">
	...
	<?endif;?>
	<h2 class="bx-title"><?= Loc::getMessage('MAIN_AUTH_CHD_HEADER');?></h2>
		<div class="bx-authform-formgroup-container">
			<div class="bx-authform-label-container"><?= Loc::getMessage('MAIN_AUTH_CHD_FIELD_LOGIN');?></div>
			<div class="bx-authform-input-container">
				<input type="text" name="<?= $fields['login'];?>" maxlength="255" value="<?= \htmlspecialcharsbx($_GET["USER_LOGIN"]);?>" />
			</div>
		</div>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="<?= $fields['checkword'];?>" maxlength="255" value="<?= \htmlspecialcharsbx($_GET["USER_CHECKWORD"]);?>" />
			</div>
		</div>
		...
		<?if ($arResult['AUTH_AUTH_URL'] || $arResult['AUTH_REGISTER_URL']):?>
			...
			<?if ($arResult['AUTH_AUTH_URL']):?>
				<p><a href="<?= $arResult['AUTH_AUTH_URL'];?>" rel="nofollow"><?= Loc::getMessage('MAIN_AUTH_CHD_URL_AUTH_URL');?></a></p>
			<?endif;?>
			<?if ($arResult['AUTH_REGISTER_URL']):?>
				<p><a href="<?= $arResult['AUTH_REGISTER_URL'];?>" rel="nofollow"><?= Loc::getMessage('MAIN_AUTH_CHD_URL_REGISTER_URL');?></a></p>
			<?endif;?>
			</noindex>
		<?endif;?>
