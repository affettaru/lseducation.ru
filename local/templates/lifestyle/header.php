...
<html lang="<?= LANGUAGE_ID ?>">
    <head>
        ...
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/public/assets/css/app.css?v=36");
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/public/assets/css/affetta.css?v=36");
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/public/assets/css/front.css?v=36");
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/public/assets/css/affetta_mod1.css?v=36");
        ...
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/public/assets/js/app.js?v=36");
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/public/assets/js/affetta.js?v=36");
        ?>
